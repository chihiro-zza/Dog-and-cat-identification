...
def main():
    ...
    if os.path.exists(model_save_path):
        ...
        model = GoogLeNet(num_classes=1, aux_logits=True, init_weights=True)
    ...
    def train(model, device, train_loader, optimizer, epoch):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            loss0 = F.binary_cross_entropy(logits, target)
            loss1 = F.binary_cross_entropy(aux_logits1, target)
            loss2 = F.binary_cross_entropy(aux_logits2, target)
